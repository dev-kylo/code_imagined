...
const UnSubscribed = () => {
    return (
        <Providers>
            <PageTitle>You will no longer receive updates on The Syncer Program course.</PageTitle>
            <TextContainer>
                <p>
                    Thanks for choosing to remain subscribed. In the next few weeks I will make sure you don't receive
                    any updates about the release of The Syncer Program.
                </p>
                <p>
                    While you are here, can you let me know how I can help you? I can then make sure you receive the
                    updates that are relevant to you.
                </p>
