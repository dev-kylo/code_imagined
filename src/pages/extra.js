    ...
    return (
        <Providers>
            ...
            <TextContainer>
                <p>
                    {' '}
                    Here is a list of my favourite resources and extra reading material for javascript, visual learning
                    and mnemonics.{' '}
                </p>
                ...
                <ul>
                    <li>
                        <Link to="/posts/why-javascript-is-difficult">Why Learning Javascript is Difficult.</Link>
                    </li>
                    <li>
                        <Link to="/posts/learning-from-the-challenges-of-other-coders/">
                ...
                <ul>
                    ...
                    <li>
                        <a target="_blank" rel="noopener noreferrer" href="https://javascript30.com/">
                ...
                <ul>
                    <li>
                        <a target="_blank" rel="noopener noreferrer" href="https://maggieappleton.com/">
                            Illustrated.dev
                        </a>{' '}
                        - a digital garden by Maggie Appleton
                    </li>
                    <li>
                        <a target="_blank" rel="noopener noreferrer" href="https://justjavascript.com/">
                            Just Javascript
                        </a>{' '}
                        - JS Mental Model by Dan Abramov
                    </li>
                    <li>
                        <a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/watch?v=8pTEmbeENF4">
                ...
                <ul>
                    ...
                    <li>
                        <a target="_blank" rel="noopener noreferrer" href="https://artofmemory.com/">
                            The Art of Memory
                        </a>{' '}
