    ...
    return (
        <Providers>
            ...
            <Container>
                <TextContainer>
                    <p>
                        Here is a list of my favourite resources and extra reading material for JavaScript, visual
                        learning and mnemonics.
                    </p>
                    <p>
                        For the ultimate visual learning experience that uses memory techniques to build a visual model
                        of JavaScript, make sure to check out{' '}
