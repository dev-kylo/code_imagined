...
const Subscribe = () => {
  return (
    <>
      ...
      <Providers>
        <PageTitle postTitle>
          Join the waiting list for The Syncer Program
        </PageTitle>
        <TextContainer>
          <p>
            You will be the first to know when doors open once more. In the
            meantime I will send a taster of The Great Sync.
          </p>
