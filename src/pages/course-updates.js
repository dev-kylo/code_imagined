    ...
    return (
        <Providers>
            ...
            <TextContainer autoHeight>
                ...
                <P>
                    I use the models every day as a developer, and have taught countless students and juniors. This is
                    the first time all of the material is consolidated in one place.
                </P>
                <P>
                    {' '}
                    Included will be visualizations and models of all the main concepts in JavaScript, along with
                    videos, text and code snippets, which will build a complete picture of javascript and how everthing
                    fits together.
                </P>
                <P>
                    It will break down not only the fundamentals, but the patterns for building DRY and SOLID programs,
                    which can be applied to any project or application.
                </P>
                <P>
                    Make sure you are subscribed to my emails, follow me on Instagram and help me spread the word of the
                    launch 🙏
                </P>
                {/* <MainVideo /> */}
            </TextContainer>
