...
const Subscribed = () => {
    return (
        <Providers>
            ...
            <TextContainer>
                <p>
                    Over the next few days I will be sending you a series of emails, where I will show you how to build
                    a mental model with story and visual analogy, and introduce you to The Great Sync.
                </p>
                <p>
                    Before you go, I WOULD love to hear from you and understand a bit more about your background and
                    goals.
                </p>
