...
import BurgerMenu from '../topnav/burgerMenu'
import DrawerItem from './drawerItem'
import { SignupContext } from '../../../context/toggle'
import { Hl } from '../../UI/text.styled'
    ...
    return (
        <MenuContainer>
            <Menu
                ...
                customBurgerIcon={
                    <ButtonWrapper>
                        <BurgerMenu hide={menuIsOpen} click={openMenu} />
                    </ButtonWrapper>
                }
            >
                <Flex justifyContent="center" alignItems="center">
                    <Text fontSize={[14, 14, 18, 18]}>
                        <Hl red={!animate}>Animations {animate ? 'ON' : 'OFF'}</Hl>
                    </Text>
                ...
                <ul style={{ width: '100%' }}>
                    ...
                    <DrawerItem>
                        <Link to="/subscribe  ">The Syncer Program - Course</Link>
                    </DrawerItem>
                    <DrawerItem>
                        <a
                            target="_blank"
                    ...
                    <DrawerItem>
                        <Link to="/extra">Extra Reading</Link>
                    </DrawerItem>
                </ul>
            </Menu>
        </MenuContainer>
